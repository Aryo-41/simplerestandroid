...
public class UpdateMinuman extends AppCompatActivity {
    ...
    private void getMinuman(){
        class GetMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequestParam("https://aryodew.000webhostapp.com/web_service/Minuman/get_minuman.php?no=",id);
                return s;
            }
        }
    ...
    private void updateMinuman(){
        ...
        class UpMinuman extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest("https://aryodew.000webhostapp.com/web_service/Minuman/update_minuman.php", hashMap);
    ...
    private void deleteMinuman(){
        class DeleteMinuman extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam("https://aryodew.000webhostapp.com/web_service/Minuman/delete_minuman.php?no=", id);
                return s;
            }
        }
